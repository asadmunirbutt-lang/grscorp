...
const doc = new Document({
  sections: [{
    ...
    children: [
      ...
      p([BOLD("Revenue: "), NORMAL("$30,000–$37,000 (GRSCorp $5–7K, Google Ads $10K, Microsoft $5K, Foundation grants $10–15K)")]),
      p([BOLD("Expenses: "), NORMAL("~$35,000–$40,000 (Legal, OPWDD, insurance, property search, staff recruitment, marketing, training)")]),
      p([BOLD("Net: "), NORMAL("Break-even to slight surplus (relying on grants to cover setup costs)")]),
      ...
      p("GRSCorp (private foundation) will make qualifying distributions to Spectrum Arch for Year 1 startup: $5,000–$7,000 to cover initial legal setup, OPWDD orientation, and critical infrastructure. Year 2 forward: Spectrum Arch self-sufficient through Medicaid and grant revenue."),
...
Packer.toBuffer(doc).then(buffer => {
  fs.writeFileSync("C:\\Users\\Asadm\\Documents\\GSCorp\\Spectrum_Arch_Business_Plan.docx", buffer);
